...
class ROSGPTClient(Node):
    ...
    def send_text_command(self):
        ...
        """
        while rclpy.ok():
            print('Enter a move command or a rotate command. The current ROSGPTParser of drone does not multiple command. Will be extended later')
            ...
            if response.status_code == 200:
                ...
                self.get_logger().error(response.content.decode('utf-8'))
